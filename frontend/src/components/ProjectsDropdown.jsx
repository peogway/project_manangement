...
const ProjectsDropDown = ({
	...
	return (
		<div
			...
			} min-w-[250px] max-w-[600px] whitespace-nowrap bg-white absolute p-3 select-none  user-select-none border border-slate-50 w-auto shadow-md box rounded-lg flex flex-col gap-2 
			${
				showAllProject === true
